...
DEFAULT_MODEL_PATH = "/scratch/home/belghmi/models/Qwen3-Embedding-8B"
RERANKER_MODEL_NAME = "BAAI/bge-reranker-v2-m3"
LLM_MODEL_NAME = "swiss-ai/Apertus-70B-Instruct-2509"


SYSTEM_PROMPT = """You are a precise research assistant for the Huggingface documentation.
...
# --- Reranking (still uses EPFL API — fast, not the bottleneck) ---
...
# --- Generation (still uses EPFL API — swap base_url for local vllm when CPT model is ready) ---
def generate_answer(
    query: str,
...
class RAG:
    def __init__(
        ...
        # Embedding model loads locally from NAS3 — no API call
...
if __name__ == "__main__":
    ...
    parser.add_argument("--reranker", type=str, default=RERANKER_MODEL_NAME, help="Reranker model name (EPFL API)")
